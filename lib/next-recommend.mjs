...
/** @typedef {{ repo: string, reportOnly?: boolean, answered: number, openPRs: number, slotsFree: number, startable: string[], triageState: number, todoNotReady: number, orphanedClaims: number, blocked: number, triageHeld: number, ready: number, inProgress: number }} QueueSummary */
