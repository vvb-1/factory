---
description: File harness friction observed in an interactive session — capture only, never implement
argument-hint: [optional: friction to file; default scan this conversation]
model: sonnet
---
